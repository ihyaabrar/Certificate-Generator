...
export default function SportRedTemplate({ data, scale = 1 }: Props) {
  return (
    <div
    ...
    >
      ...
      <div style={{
        ...
        background: 'rgba(255,255,255,0.08)', transform: 'skewX(-10deg)',
      }} />
      <div style={{
        position: 'absolute', top: 0, left: '65%', width: 30, bottom: 0,
        background: 'rgba(255,255,255,0.05)', transform: 'skewX(-10deg)',
      }} />
      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 10 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 'bold', color: '#fecaca' }}>{data.eventTitle}</div>
